'''### Bài 1: Bài tập tổng hợp phần Basic - Đếm từ ### 
...
m = [(1, 2, 5), (9, 1, 2), (6, 4, 4), (3, 2, 3), (10, 2, 1)]
print("\t Kết quả sau khi sắp xếp: ", sorting(m))
...
print("\t Chuỗi gốc ban đầu là: ", s)
print("\t Kết quả sau khi đảo chuỗi là: ", reverse_and_swap(s))